...
export enum AiAssistantType {
  ...
  OPS_OPERATIONS = 'OPS_OPERATIONS',
  PARENT_SUPPORT = 'PARENT_SUPPORT',
  INTERNAL_SUPPORT = 'INTERNAL_SUPPORT',
  TEACHER_SUPPORT = 'TEACHER_SUPPORT',
  EXPERIENCE_TEACHER_SUPPORT = 'EXPERIENCE_TEACHER_SUPPORT',
  STUDENT_SUPPORT = 'STUDENT_SUPPORT',
  SALE_OPERATIONS = 'SALE_OPERATIONS',
  ADS_OPERATIONS = 'ADS_OPERATIONS',
  SHAREHOLDER_INSIGHTS = 'SHAREHOLDER_INSIGHTS',
  LEAD_CARE = 'LEAD_CARE',
}
